...
public class Steps extends BasePage{
	...
	public void user_has_launched_browser() {
	    // Write code here that turns the phrase above into concrete action
		 ...
		 logger.info("*********Opening Blank Browser*********");
	     openBrowser();
	...
	public void clicks_Signin_link_on_the_page(String string) {
	    // Write code here that turns the phrase above into concrete actions
	   logger.info("*********Clicking SignIn Link on MyStore Page*********");
	...
	public void navigates_to_Page(String string) {
	    // Write code here that turns the phrase above into concrete actions
		 logger.info("*********Verifying Page Navigation*********");
	...
	public void clicks_on_SignIn_button_on_the_page(String string) {
	    // Write code here that turns the phrase above into concrete actions
		logger.info("*********Clicking SignIn button on Login page*********");
	...
	public void clicks_Signout_link_on_the_page(String string) {
	    // Write code here that turns the phrase above into concrete actions
		logger.info("*********Clicking SignOut Link on the Account page*********");
